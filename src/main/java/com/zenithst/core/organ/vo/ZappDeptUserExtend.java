...
* <pre>
* <b>
* 1) Description : Wrapper class for extended department user (OUT) <br>
* 2) History : <br>
*         - v1.0 / 2020.11.04 / khlee / New
* 
* 3) Usage or Example : <br>
*
*    ZappDeptUserExtend pIn = new ZappDeptUserExtend();
*    ...
*    <br>    
* 
...
public class ZappDeptUserExtend extends ZappDeptUser {
