...
* <pre>
* <b>
* 1) Description : The purpose of this interface is to map system log data. <br>
* 2) History : <br>
...
public interface ZappSystemLogMapper extends ZappMapper  {
    ...
    ZappSystemLog selectByPrimaryKey(String pk);
    int updateByDynamic(@Param("vo") ZappSystemLog vo, @Param("dynamic") ZappDynamic dynamic);
    int updateByPrimaryKey(ZappSystemLog vo);
