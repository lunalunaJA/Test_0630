...
* <pre>
* <b>
* 1) Description : Wrapper class for content log <br>
* 2) History : <br>
...
*    <caption>ZAPP_CONTENTLOG</caption>
* 	 <tr bgcolor="#12F0C9">
...
* 	 </tr>
* 	 <tr bgcolor="#8EECDB">
* 	   <td>10</td><td>logtype</td><td></td><td></td><td></td><td>VARCHAR(2)</td><td></td><td>Logging type<br>(01:Bundle,02:File,03:Classification,04:Link,05:Share,06:Lock)</td>
* 	 </tr>
* 	 <tr bgcolor="#8EECDB">
...
public class ZappContentLog extends ZappDomain {
     ...
     * @param logid pk
     */ 
	public ZappContentLog(String logid) {
		this.logid = logid;
	} 
