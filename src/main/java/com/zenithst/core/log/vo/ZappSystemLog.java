...
* <pre>
* <b>
* 1) Description : Wrapper class for system log <br>
* 2) History : <br>
...
*    <caption>ZAPP_SYSTEMLOG</caption>
* 	 <tr bgcolor="#12F0C9">
...
* 	 </tr>
* 	 <tr bgcolor="#8EECDB">
* 	   <td>10</td><td>logtype</td><td></td><td></td><td></td><td>VARCHAR(2)</td><td></td><td>Logging type<br>(A1:Company,02:Department,03:User,04:Group,11:Preferences,12:Code)</td>
* 	 </tr>
* 	 <tr bgcolor="#8EECDB">
* 	   <td>11</td><td>action</td><td></td><td></td><td></td><td>CHAR(1)</td><td></td><td>Processing type<br>(A1:New,B1:Edit,C1:Move,D1:Copy,E1:Delete,<br>F1:Discard,G1:View,H1:Reorder,Y1:Link,Z1:Share)</td>
* 	 </tr>
* 	 <tr bgcolor="#8EECDB">
...
public class ZappSystemLog extends ZappDomain {
    ...
    /**
	 * <p><b>
	 * [OUT] Logging info. (Multiple)
	 * </b></p>
	 * 
     * @return Logging info. (Multiple)
     */	
    ...
    /**
	 * <p><b>
	 * [IN] Logging info. (Multiple)
	 * </b></p>
     *
     * @param maplogs Logging info. (Multiple)
     */
     ...
     * @param logid pk
     */ 
	public ZappSystemLog(String logid) {
		this.logid = logid;
	} 
}