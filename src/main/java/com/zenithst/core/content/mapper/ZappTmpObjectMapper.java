...
* <pre>
* <b>
* 1) Description : The purpose of this interface is to map temporary data. <br>
* 2) History : <br>
...
public interface ZappTmpObjectMapper extends ZappMapper {

    int countByDynamic(@Param("dynamic") ZappDynamic dynamic);
    int deleteByDynamic(@Param("dynamic") ZappDynamic dynamic);
    int deleteByPrimaryKey(String pk);
    int insert(ZappTmpObject vo);
    int insertu(ZappTmpObject vo);
    @SuppressWarnings("rawtypes")
	List selectByDynamic(@Param("dynamic") ZappDynamic dynamic);
    @SuppressWarnings("rawtypes")
	List selectExtendByDynamic(@Param("dynamic") ZappDynamic dynamic);
    ZappTmpObject selectByPrimaryKey(String pk);
    int updateByDynamic(@Param("vo") ZappTmpObject vo, @Param("dynamic") ZappDynamic dynamic);
    int updateByPrimaryKey(ZappTmpObject vo);
