...
* <pre>
* <b>
* 1) Description : The purpose of this interface is to map bundle data. <br>
* 2) History : <br>
...
public interface ZappBundleMapper extends ZappMapper {

    int countByDynamic(@Param("dynamic") ZappDynamic dynamic);
    int deleteByDynamic(@Param("dynamic") ZappDynamic dynamic);
    int deleteByPrimaryKey(String pk);
    int insert(ZappBundle vo);
    int insertu(ZappBundle vo);
    @SuppressWarnings("rawtypes")
	List selectByDynamic(@Param("dynamic") ZappDynamic dynamic);
    ZappBundle selectByPrimaryKey(String pk);
    int updateByDynamic(@Param("vo") ZappBundle vo, @Param("dynamic") ZappDynamic dynamic);
    int updateByPrimaryKey(ZappBundle vo);
